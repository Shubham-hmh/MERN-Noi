        ...
        if (sortBy) {
            sortedTodos.sort((a, b) => {
                if (sortBy === 'title') {
                    ...
                    return sortType === 'asc' ? a.priority.localeCompare(b.priority) : b.priority.localeCompare(a.priority);
                }
            });
        }
    }
    ...
    return (
        <div className="container mt-5">
            <p className="sort-info">
                Click Title, Creation Time, Priority for sorting <span className="star">&#9733;</span> {new Date().toLocaleTimeString()}
            </p>
            <div className="mb-3">
                <input
                    type="text"
                    ...
                    <thead className="table-dark">
                        <tr>
                            ...
                            <th onClick={() => handleSort('priority')}>
                                <div className="header-cell">
                                    Priority
                                    <span className="sort-icon">{getSortIcon('priority')}</span>
                                </div>
                            </th>
                            <th>
                                <div className="header-cell">
                        ...
                        {currentTodos.map((element, index) => {
                            ...
                            return (
                                <tr key={element._id}>
                                    ...
                                    <td>{creationTime}</td>
                                    <td>
                                        <NavLink to={`edit/${element._id}`} className="btn btn-primary me-2">
                                            <CreateIcon />
                                        </NavLink>
