                ...
                <form className="mt-4" onSubmit={formik.handleSubmit}>
                    ...
                    <div className="row">
                        <div className="mb-3 col-lg-12">
                            ...
                            <select name="priority" value={formik.values.priority} onChange={formik.handleChange} onBlur={formik.handleBlur} className="form-control" id="priority">
                                <option value="High">High</option>
                                <option value="Low">Low</option>
                            </select>
                            {formik.touched.priority && formik.errors.priority && <div className="error">{formik.errors.priority}</div>}
                        </div>
                    </div>
                    <div className="row">
                        <div className="mb-3 col-lg-12">
